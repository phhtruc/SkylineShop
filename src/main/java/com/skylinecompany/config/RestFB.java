...
public class RestFB {
	...
	public static String FACEBOOK_APP_ID = "327907686544690";
    public static String FACEBOOK_APP_SECRET = "9577cc80176eb0c677d8983fd06b3cdf";
    public static String FACEBOOK_REDIRECT_URL = "https://localhost:8888/SkylineShop/login-facebook";
    ...
    public UserDetails buildUser(com.restfb.types.User user) {
        ...
        MyUser myUser = new MyUser(user.getId(), "", true, true, true, true, authorities);

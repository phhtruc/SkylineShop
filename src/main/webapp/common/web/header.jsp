...
<!-- Page Preloder 
    ...
    <div class="offcanvas-menu-wrapper">
      ...
      <div class="offcanvas__nav__option">
        ...
        <a href="#"><img src="template/web/img/icon/cart.png" alt="" /> <span>0</span></a>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3">
            <div class="header__logo">
              <a href="./trang-chu"><img src="template/web/img/logo_skyline.png" alt="" /></a>
            </div>
          </div>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="./shop-details">Chi tiết sản phẩm</a></li>

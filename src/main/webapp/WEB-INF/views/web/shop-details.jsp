                ...
                <li class="nav-item">
                  ...
                  >
                    <div
                      ...
                      data-setbg="template/web/img/shop-details/thumb-1.png"
                    ></div>
                  </a>
                </li>
                <li class="nav-item">
                  ...
                  >
                    <div
                      class="product__thumb__pic set-bg"
                      data-setbg="template/web/img/shop-details/thumb-2.png"
                    ></div>
                  </a>
                </li>
                <li class="nav-item">
                  ...
                  >
                    <div
                      class="product__thumb__pic set-bg"
                      data-setbg="template/web/img/shop-details/thumb-3.png"
                    ></div>
                  </a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-lg-6 col-md-9">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tabs-4" role="tabpanel">
                  <div class="product__details__pic__item">
                    <img src="template/web/img/shop-details/product-big-4.png" alt="" />
                    <a
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
            <div class="product__item">
              <div class="product__item__pic" data-setbg="">
                <img class=" set-bg" src="template/web/img/product/product-1.jpg">

...
<html lang="zxx">
  <head>
    ...
    <link
      rel="stylesheet"
      href="template/web/css/bootstrap.min.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/font-awesome.min.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/elegant-icons.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/magnific-popup.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/nice-select.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/owl.carousel.min.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="template/web/css/slicknav.min.css"
      type="text/css"
    />
            ...
            <div
              ...
              <div class="product__item wow fadeInUpBig" data-wow-delay="0.6s">
                ...
                <div class="product__item__text">
                  <a
                    class="product-title"
                    href="<c:url value='/shop-details/${b.product_name}'/>"
                    ><h6>${b.product_name}</h6></a
                  >
          ...
          <div class="col-lg-8">
            <div class="instagram__pic">
              <div
                ...
                data-setbg="template/web/img/instagram/instagram-1.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="template/web/img/instagram/instagram-2.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="template/web/img/instagram/instagram-3.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="template/web/img/instagram/instagram-4.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="template/web/img/instagram/instagram-5.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="template/web/img/instagram/instagram-6.jpg"
              ></div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="instagram__text">
              <h2>Instagram</h2>
              <p>
                <a href="https://www.instagram.com/phhtruc.10/"
                  >Theo dõi Instagram của chúng tôi</a
                >
              </p>
              <h3>#Skyline_Shop</h3>
            </div>
        ...
        <div class="row wow fadeInUpBig" data-wow-delay="0.5s">
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                ...
                data-setbg="template/web/img/blog/blog-1.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="template/web/img/icon/calendar.png" alt="" /> 16
                  tháng 2 2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="template/web/img/blog/blog-2.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="template/web/img/icon/calendar.png" alt="" /> Ngày
                  21 tháng 2 2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="template/web/img/blog/blog-3.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="template/web/img/icon/calendar.png" alt="" /> Ngày
                  28 tháng 2 2020</span
                >

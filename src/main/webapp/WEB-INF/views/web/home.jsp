...
<title>Skyline Shop - Trang chủ</title>
</head>
<body>
	<!-- Hero Section Begin -->
	<section class="hero">
		<div class="hero__slider owl-carousel">
						...
						<div class="col-xl-5 col-lg-7 col-md-8">
							<div class="hero__text wow fadeInUp" data-wow-delay="0.9s">
								...
								<a href="shop.html" class="primary-btn wow fadeInUp"
									data-wow-delay="1.8s">Mua ngay <span
			...
			<div class="hero__items set-bg" data-setbg="template/web/img/hero/hero-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-5 col-lg-7 col-md-8">
							<div class="hero__text wow fadeInUp" data-wow-delay="0.9s">
		...
		<div class="container">
			...
			<div class="row product__filter">
				<div
					...
					<div class="product__item wow fadeInUpBig" data-wow-delay="0.6s">
						...
						<div class="product__item__text">
							<a class="product-title" href="shop-details.html"><h6>Piqué
									Biker Jacket</h6></a>
							<div class="rating">
				...
				<div
					...
					<div class="product__item sale wow fadeInUpBig"
						data-wow-delay="0.6s">
						<div class="product__item__pic set-bg"
				...
				<div
					...
					<div class="product__item wow fadeInUpBig" data-wow-delay="0.5s">
						<div class="product__item__pic set-bg"
							data-setbg="template/web/img/product/product-5.jpg">
							<ul class="product__hover">
								<li><a href="#"><img src="template/web/img/icon/heart.png" alt="" /></a>
								</li>
								<li><a href="#"><img
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						...
						<div class="blog__item__text">
							<span><img src="template/web/img/icon/calendar.png"
								alt="" /> 16 tháng 2 2020</span>

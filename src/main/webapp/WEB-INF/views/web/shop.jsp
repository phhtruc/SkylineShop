                        ...
                        <div class="shop__sidebar__categories">
                          <ul class="nice-scroll">
                            <c:forEach items="${cate}" var="c">
                              <li>
                                <a
                                  href="<c:url value='/shop/category/${c.cate_name}'/>"
                                  >${c.cate_name}</a
                                >
                              </li>
                            </c:forEach>
                        ...
                        <div class="shop__sidebar__brand">
                          <ul>
                            <c:forEach items="${brand}" var="b">
                              <li>
                                <a
                                  href="<c:url value='/shop/brand/${b.brand_name}'/>"
                                  >${b.brand_name}</a
                                >
                              </li>
                            </c:forEach>
                      ...
                      >
                        ...
                        <div class="product__item__text">
                          <a
                            class="product-title"
                            href="<c:url value='/shop-details/${p.product_name}'/>"
                            ><h6>${p.product_name}</h6></a
                          >
                          <a href="#" class="add-cart"
                            ><i class="fa-solid fa-cart-plus me-2"></i>Thêm vào
                            giỏ hàng</a
                          >
                          <div class="rating">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="product__pagination">
                  ...
                  <a href="#">3</a> <span>...</span> <a href="#">21</a>
                </div>
              </div>
            </div>
          </div>

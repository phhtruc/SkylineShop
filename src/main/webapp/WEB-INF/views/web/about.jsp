...
<title>Skyline - Về chúng tôi</title>
...
<!-- font-awesome -->
<link rel="stylesheet"
	href="https://cdnjs.cloudflqare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="about__pic">
						<img src="template/web/img/about/about-us.jpg" alt="" />
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-6 p-0">
					<div class="testimonial__pic set-bg"
						data-setbg="template/web/img/about/testimonial-pic.jpg"></div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-1.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-2.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-3.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-4.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-5.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-6.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-7.png" alt="" /></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="template/web/img/clients/client-8.png" alt="" /></a>
				</div>
			</div>
		</div>
	</section>
